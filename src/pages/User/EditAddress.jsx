    ...
    const fetchOrderAddressData = async () => {
      try {
        ...
        const selectedProvinceCode = provincesList.find(
          (p) => p.name === orderAddressData.city
        )?.code;
        ...
        if (selectedProvinceCode) {
          ...
          const selectedDistrictCode = districtsList.find(
            (d) => d.name === orderAddressData.district
          )?.code;
          ...
          if (selectedDistrictCode) {
            ...
            const selectedCommuneCode = communesList.find(
              (c) => c.name === orderAddressData.commune
            )?.code;
        ...
        setPhone(orderAddressData.phone);
        setStreet(orderAddressData.street);
      } catch (error) {
