        ...
        <div className="flex flex-row gap-x-20 px-40 py-20">
          <div className="flex flex-col gap-y-6 w-[800px]">
              ...
              <div className="flex flex-col gap-y-6">
                ...
                <div className="flex flex-col items-start gap-5">
                  ...
                  <div className="flex flex-row gap-5">
                    {!selectedUserAddress && (
                      <button
                        className="bg-[#0A0A0A] px-6 py-2 rounded-lg text-white font-semibold"
            ...
            {!auth.isAuth && userType === USER_TYPE.CUSTOMER && (
              <button
                className="px-10 py-3 text-white font-medium bg-black rounded-lg self-center"
                onClick={handleLogin}
              >
        ...
        <Modal.Body className="px-10 pb-10">
          <div className="space-y-4">
            ...
            <div className="w-full flex justify-center">
              <button
                className="px-6 py-2 rounded bg-[#0A0A0A] text-white font-bold mt-6"
