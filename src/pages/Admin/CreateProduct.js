      ...
      <div className="bg-white rounded-lg mt-10 p-6 shadow-md flex flex-col gap-y-5">
        ...
        {variants.map((variant, index) => (
          <main key={index} className="relative mb-2">
            ...
            {variants.length > 1 && (
              <button
                className="font-medium text-[#EF0606] items-center flex w-fit h-fit absolute right-4 bottom-4"
        ...
        <div className="flex justify-end">
          <button
            className="border border-[#0a0a0a] rounded-lg flex items-center px-4 py-3 gap-x-2"
